 ...
 * @returns
 */	
 function fuzzySearch(zTreeId, searchField, isHighLight, isExpand, callBack, zTreeOnCheck){
	...
	function processShowNodes(nodesShow,_keywords){
		if(nodesShow && nodesShow.length>0){
			...
			if(_keywords.length>0){ 
				...
				if (!nodesShow[0].children) {
					zTreeOnCheck(null, null, nodesShow[0].getParentNode())
				}else{
					zTreeOnCheck(null, null, nodesShow[0])
				}
